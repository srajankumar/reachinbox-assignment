...
//   // Handle the "R" key to open the reply drawer
//   useEffect(() => {
...
//   // Handle the "D" key to delete the thread
//   useEffect(() => {
//     const handleKeyDown = (event: KeyboardEvent) => {
...
//       body: replyBody,
//       references: messages.map((msg) => msg.id), // Adjust as per your need
//       inReplyTo: messages[messages.length - 1]?.id, // Last message id
//     };
...
//             <DrawerDescription>Fill in your reply and send.</DrawerDescription>
//           </DrawerHeader>
//           <div className="px-4">
//             <Input
//               type="text"
